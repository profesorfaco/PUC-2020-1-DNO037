...
- **En la mezcla de [p5.js](https://p5js.org/es/reference/) y [Leafleft.js](https://leafletjs.com/reference-1.6.0.html) obtendremos un mapa** donde se marcan los epicentros de los temblores de +4.5M de la última semana, según datos de https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson
